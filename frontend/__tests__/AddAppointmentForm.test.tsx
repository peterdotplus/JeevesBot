...
describe('AddAppointmentForm Component', () => {
  ...
  it('renders form with all fields', () => {
    ...
    expect(screen.getByLabelText('Date (DD-MM-YYYY)')).toBeInTheDocument();
  ...
  it('validates required fields', async () => {
    ...
    const submitButton = screen.getByRole('button', { name: 'Add Appointment' });
  ...
  it('validates date format', async () => {
    ...
    const dateInput = screen.getByLabelText('Date (DD-MM-YYYY)');
    ...
    await waitFor(() => {
      expect(screen.getByText('Date must be in DD-MM-YYYY format')).toBeInTheDocument();
    });
  ...
  it('validates time format', async () => {
    ...
    const timeInput = screen.getByLabelText('Time (HH:MM)');
    ...
    await waitFor(() => {
      expect(screen.getByText('Time must be in HH:MM format')).toBeInTheDocument();
    });
  ...
  it('submits form with valid data', async () => {
    ...
    fireEvent.change(screen.getByLabelText('Date (DD-MM-YYYY)'), {
